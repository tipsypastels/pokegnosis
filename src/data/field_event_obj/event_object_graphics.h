...
const u32 gEventObjectPic_Oddish[] = INCBIN_U32("graphics/event_objects/pics/pokemon/oddish.4bpp");
...
const u16 gEventObjectPaletteGnosisMons1[] = INCBIN_U16("graphics/event_objects/palettes/gnosis_mons_1.gbapal");
