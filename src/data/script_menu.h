...
static const struct MenuAction MultichoiceList_YamakiTownOldLady[] =
{
    {gText_YamakiTownOldLady_Boat},
    {gText_YamakiTownOldLady_Duck},
    {gText_YamakiTownOldLady_Reflection},
    {gText_YamakiTownOldLady_LegendaryMon},
    {gText_Exit},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_YAMAKI_TOWN_OLD_LADY]       = MULTICHOICE(MultichoiceList_YamakiTownOldLady)
};
