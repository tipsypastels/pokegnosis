...
const u32 gTrainerBackPalette_Brendan[] = INCBIN_U32("graphics/trainers/palettes/brendan_back.gbapal.lz");
...
const u32 gTrainerBackPalette_May[] = INCBIN_U32("graphics/trainers/palettes/may_back.gbapal.lz");
