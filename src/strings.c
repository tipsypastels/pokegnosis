...
const u8 gText_DefaultNameKai[] = _("Kai");
const u8 gText_DefaultNameMeili[] = _("Meili");
const u8 gText_ThisIsAPokemon[] = _("What are {COLOR POKEMON_COLOR}Pokémon{COLOR NO_COLOR} you ask?{PAUSE 96}\p");
...
const u8 gText_BirchInTrouble[] = _("{COLOR POKEMON_COLOR}Dragon eggs{COLOR NO_COLOR}! What kind of {COLOR POKEMON_COLOR}Pokémon{COLOR NO_COLOR}\ncould be in inside?");
...
const u8 gText_YamakiTownOldLady_Boat[] = _("Boat");
const u8 gText_YamakiTownOldLady_Duck[] = _("Duck");
const u8 gText_YamakiTownOldLady_Reflection[] = _("Mirage");
const u8 gText_YamakiTownOldLady_LegendaryMon[] = _("Shadow");
...
const u8 gText_Exit[] = _("{COLOR RED}Exit{COLOR NO_COLOR}");
...
const u8 gText_MenuPokedex[] = _("{HIGHLIGHT TRANSPARENT}Pokédex{HIGHLIGHT WHITE}");
const u8 gText_MenuPokemon[] = _("{HIGHLIGHT TRANSPARENT}Pokémon{HIGHLIGHT WHITE}");
const u8 gText_MenuBag[] = _("{HIGHLIGHT TRANSPARENT}Bag{HIGHLIGHT WHITE}");
const u8 gText_MenuPokenav[] = _("{HIGHLIGHT TRANSPARENT}Pokénav{HIGHLIGHT WHITE}");
const u8 gText_MenuPlayer[] = _("{HIGHLIGHT TRANSPARENT}{PLAYER}{HIGHLIGHT WHITE}");
const u8 gText_MenuSave[] = _("{HIGHLIGHT TRANSPARENT}Save{HIGHLIGHT WHITE}");
const u8 gText_MenuOption[] = _("{HIGHLIGHT TRANSPARENT}Option{HIGHLIGHT WHITE}");
const u8 gText_MenuExit[] = _("{HIGHLIGHT TRANSPARENT}Exit{HIGHLIGHT WHITE}");
const u8 gText_MenuRetire[] = _("{HIGHLIGHT TRANSPARENT}Retire{HIGHLIGHT WHITE}");
const u8 gText_MenuRest[] = _("{HIGHLIGHT TRANSPARENT}Rest{HIGHLIGHT WHITE}");
