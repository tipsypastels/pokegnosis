...
{
    [MAPSEC_YAMAKI_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KURIBI_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_YUGASA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SHIAXIA_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_YAMAKI_LAKE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DOWNY_RANCH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_JUNGLE_HIGHWAY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WOODLAND_ESTATE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DUCK_TEMPLE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_106] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_RIVER_HIGHWAY] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ROUTE_108] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_JINXHOU_SNOWDOWN] = MAPPOPUP_THEME_UNDERWATER,
